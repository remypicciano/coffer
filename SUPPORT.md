...
- Review the [threat model](docs/threat-model.md) before relying on Coffer for a particular adversary or environment.
- Use a bug report only with synthetic data and sanitized paths.
...
Coffer has no recovery backdoor. Lost key material cannot be recreated by the developer.
